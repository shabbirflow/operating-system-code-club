...
void producer(int j) {
    do {
        ...
        std::cout<<"Critical Section: Producer produces an item and puts it into the buffer"<<std::endl;
...
void consumer(int i) {
    do {
        ...
        std::cout<<"Critical Section: Consumer consumes an item from the buffer"<<std::endl;
